...
def search_information(query: str) -> str:
    ...
    # Check for keywords in the query to provide better matches
    if "weather" in query_lower and "london" in query_lower:
    ...
    elif "population" in query_lower and "earth" in query_lower:
        result = "The estimated population of Earth is around 8 billion people."
    elif "tallest" in query_lower and "mountain" in query_lower:
        result = "Mount Everest is the tallest mountain above sea level."
    elif "dogs" in query_lower:
        result = "Dogs are domesticated mammals and popular pets. They are known for their loyalty, intelligence, and companionship with humans."
    else:
